                ...
                <div className="aboutme lg:w-4/6 space-y-3">
                    ...
                    <div className="relative group w-fit mx-auto">
                        ...
                        <div className="relative z-10 bg-gradient-to-br from-black/5 to-black/20 p-2 rounded-lg backdrop-blur-sm">
                            <div className="relative overflow-hidden rounded-lg">
                                <div className="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent opacity-50"></div>
                                <img src="Mukund_new.png" alt="" width={250} height={200} className='block lg:hidden relative rounded-lg shadow-xl transition-transform duration-300 group-hover:scale-105' />
                            </div>
                        </div>
                    </div>
