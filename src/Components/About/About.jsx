    ...
    <div className='lg:w-4/6 mx-auto lg:flex justify-around gap-5 items-center'>
        ...
        <div className="aboutme lg:w-4/6 space-y-3">
            ...
            <div className="relative group w-fit mx-auto">
                ...
                <div className="absolute -top-3 -left-3 w-16 h-16 border-2 border-white/20 rounded-lg transform -rotate-6 transition-all duration-300 group-hover:rotate-0"></div>
                <div className="absolute -bottom-3 -right-3 w-16 h-16 border-2 border-white/20 rounded-lg transform rotate-6 transition-all duration-300 group-hover:rotate-0"></div>
                
                {/* Main image container for mobile */}
                <div className="relative z-10 bg-gradient-to-br from-black/5 to-black/20 p-2 rounded-lg backdrop-blur-sm">
                    <div className="relative overflow-hidden rounded-lg">
                        <div className="absolute inset-0 bg-gradient-to-tr from-white/10 to-transparent opacity-50"></div>
                        <img src="mukund_photo2.png" alt="" width={250} height={200} className='block lg:hidden relative rounded-lg shadow-xl transition-transform duration-300 group-hover:scale-105' />
                    </div>
                </div>
            </div>
