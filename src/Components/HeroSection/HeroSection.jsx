...
const HeroSection = () => {
  ...
  return (
    ...
    <div className='lg:w-4/6 mx-auto flex justify-around items-center min-h-screen z-10 p-3 lg:p-0'>
      ...
      <h3 className='relative text-white gap-2 flex items-center' style={{fontFamily:'Fira Code'}} >Hello 
        <div style={{flex:"1",height: "5px", backgroundColor: "chartreuse"}} className='w-full'></div> </h3>
